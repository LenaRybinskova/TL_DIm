...
export const Todolist = React.memo((props: PropsType) => {
    ...
    return <div>
        ...
        <div>
            {
                tasksForTodolist.map(t => <Task key={t.id} todolistId={props.id} task={t} removeTask={props.removeTask} changeTaskStatus={props.changeTaskStatus} changeTaskTitle={props.changeTaskTitle}/>)
            }
        </div>
